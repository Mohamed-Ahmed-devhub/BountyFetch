    ...
    return (
      <div style={{ background: '#F4F6F9', minHeight: '100vh' }} dir={isRTL ? 'rtl' : 'ltr'}>
        ...
        <div style={{ minHeight: 'calc(100vh - 64px)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem 1rem' }}>
          <div style={{ width: '100%', maxWidth: 440, background: '#fff', border: '1px solid #D8DEE9', borderRadius: 16, padding: 'clamp(1.25rem,5vw,2.5rem)', boxShadow: '0 4px 24px rgba(0,45,98,.08)', textAlign: 'center' }}>
